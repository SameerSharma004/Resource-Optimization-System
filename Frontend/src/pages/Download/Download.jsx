      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="text-center mb-24 space-y-8 pt-10 relative">
          ...
          <h1 className="text-6xl md:text-8xl font-black tracking-tight leading-[0.9] text-white">
            Install the <br />
            <span className="text-primary italic font-serif font-normal">Remote Agent</span>
          </h1>
          <p className="text-gray-400 max-w-2xl mx-auto text-xl font-medium leading-relaxed">
            Unleash the full power of real-time telemetry. Our lightweight agent is designed to run silently while providing massive performance insights.
          </p>
        </div>
        <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
          {[
            ...
            <div key={idx} className="group bg-white rounded-[40px] p-10 flex flex-col items-center text-center shadow-[0_20px_50px_rgba(0,0,0,0.3)] hover:-translate-y-2 transition-all duration-500 border border-white/5 relative overflow-hidden">
              <div className="absolute -top-10 -right-10 w-40 h-40 bg-black/[0.03] rounded-full group-hover:scale-150 transition-transform duration-700"></div>
              <div className={`size-20 rounded-2xl bg-black flex items-center justify-center mb-8 shadow-xl group-hover:rotate-6 transition-transform`}>
                <span className={`material-symbols-outlined text-4xl ${item.color}`}>
                  {item.icon}
                </span>
              </div>
              <h2 className="text-3xl font-black text-background-dark mb-2">{item.os}</h2>
              <p className="text-gray-500 font-bold mb-10 text-sm tracking-tight">{item.desc}</p>
              <a
                href={item.link}
              ...
              >
                <span className="relative z-10 uppercase tracking-widest text-xs">Download {item.ext}</span>
        ...
        <section className="mt-32 max-w-4xl mx-auto">
          <div className="bg-white rounded-[40px] p-12 md:p-16 shadow-2xl relative overflow-hidden border border-black/5">
            ...
            <div className="relative z-10">
              <div className="flex items-center gap-4 mb-8">
                ...
                <div>
                  <h3 className="text-2xl font-black text-background-dark leading-none">CLI Installation</h3>
                  <p className="text-gray-500 font-bold text-xs uppercase tracking-widest mt-2">Preferred for Servers</p>
                </div>
              </div>
              <div className="space-y-6">
                <p className="text-background-dark font-bold text-lg leading-relaxed">
                  Deploy the agent instantly across your Linux infrastructure using our optimized debian package.
                </p>
                  ...
                  <div className="space-y-4">
                    <div className="space-y-1">
                      <div className="text-white flex items-center gap-3">
                        ...
                        <span>sudo dpkg <span className="text-primary">-i</span> ai-optimizer-v1.0.deb</span>
                      </div>
                    </div>
                    <div className="space-y-1 pt-4">
                      <div className="text-white flex items-center gap-3">
                        <span className="text-primary font-black">$</span>
                        <span>sudo apt-get <span className="text-primary">install</span> -f</span>
                      </div>
                    </div>
                  </div>
                </div>
