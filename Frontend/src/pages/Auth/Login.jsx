    ...
    <div className="bg-background-dark min-h-screen p-4 md:p-6 selection:bg-primary/30 selection:text-white flex flex-col">
          ...
          <div className="bg-white rounded-[40px] shadow-2xl overflow-hidden border border-black/5 p-10 md:p-16">
            <div className="text-center mb-10">
              ...
              <h1 className="text-4xl md:text-5xl font-black text-background-dark leading-tight tracking-tight">
                Welcome <span className="text-primary italic font-serif">Back</span>
              </h1>
              <p className="text-gray-500 mt-4 font-medium">
                Optimizing your system starts here.
              </p>
            </div>
            {error && (
            ...
            <form onSubmit={handleSubmit} className="space-y-6 text-background-dark">
              ...
              <div className="space-y-2">
                <div className="flex justify-between items-center px-1">
                  <label className="text-xs font-black uppercase tracking-widest opacity-40" htmlFor="password">
                    Password
                  </label>
              ...
              <div className="flex items-center gap-3 py-2 ml-1">
                <input
                  className="size-5 rounded-lg border-black/10 text-primary focus:ring-primary/30 cursor-pointer"
                  id="remember"
                  type="checkbox"
                  checked={remember}
                  onChange={(e) => setRemember(e.target.checked)}
                />
                <label className="text-sm text-gray-500 font-bold cursor-pointer" htmlFor="remember">
                  Keep me signed in
                </label>
              </div>
              <button
      ...
      <footer className="py-10 text-center">
        <p className="text-xs text-gray-600 font-black uppercase tracking-widest opacity-40">
          © 2026 AI Optimizer. Built for performance.
        </p>
      </footer>
    </div>
  );
